...
var FormulariosAtencionEmergenciaPageModule = /** @class */ (function () {
    function FormulariosAtencionEmergenciaPageModule() {
    }
    FormulariosAtencionEmergenciaPageModule = tslib_1.__decorate([
        NgModule({
            entryComponents: [
    ...
    return FormulariosAtencionEmergenciaPageModule;
}());
export { FormulariosAtencionEmergenciaPageModule };
//# sourceMappingURL=formularios_atencion_emergencia.module.js.map